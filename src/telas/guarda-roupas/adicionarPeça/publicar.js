        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.imageContainer}>
                    ...
                    <TouchableOpacity style={styles.shareButton} onPress={() => this.getPicture()}>
                ...
                <View style={styles.postContainer}>
                    <View style={styles.touchableContainer}>
                        <TouchableOpacity style={styles.touchable} onPress={() => this.props.navigation.navigate('GuardaRoupa')}>
                            <Guardar alignSelf={'center'} width={76} height={76}/>
                        </TouchableOpacity>
                        <Text style={styles.text}>guardar</Text>
                    </View>
                    <View style={styles.touchableContainer}>
                        <TouchableOpacity style={styles.touchable} onPress={() => this.navigateToComporLook()}>
